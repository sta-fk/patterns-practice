...
use Factory\AbstractFactory\BookTypes\BookContent\Format\ElectronicBookOnMedia;
...
use Factory\AbstractFactory\BookTypes\BookContent\Format\OnlineElectronicBook;
...
class ElectronicBookFactory implements BookFactoryInterface
{
    ...
    {
        return match($format) {
            BookFormat::OnlineElectronic => new OnlineElectronicBook(),
            BookFormat::ElectronicOnMedia => new ElectronicBookOnMedia(),
